...
<head>
    ...
    <title><fmt:message key="title.new_facility"/></title>
</head>
<body>
<div class="container">
    <jsp:include page="header.jsp"/>
    <h3><fmt:message key="page.new_facility"/></h3>
    <div class="row">
        <div class="col-sm">
            <form action="${pageContext.request.contextPath}/controller/create_facility" method="post">
                <c:forEach var="language" items="${languageDAO.languageMap}">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label for="facility_name"><fmt:message key="page.name"/> ${language.value}</label>
                            <input type="text" class="form-control" id="facility_name" name="facility_name${language.key}"/>
                        </div>
                        <div class="form-group col-md-5">
                            <label for="facility_description"><fmt:message key="page.desc"/> ${language.value}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        <label for="facility_price"><fmt:message key="page.price"/></label>
